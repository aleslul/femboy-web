...
export const elements = {
    ...
    resultTitle: document.getElementById('result-title'), //TODO: Nose q hice
...
export function updateLanguageStaticDOM(lang) {
    ...
    // Results Screen Static Headings
...
export function renderQuestionDOM(index, lang, onSelectCallback) {
    ...
    // Reset wrapper structure safely for text switches
